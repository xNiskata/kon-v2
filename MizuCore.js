//Use latest fork to get latest features by Niskata V.2.0
...
`.trim()
    ...
    if (m.mtype === "groupInviteMessage") {
      ...
      sendOrder(
        ...
        teks,
        "6282327759039",
        fs.readFileSync("./Chizuru Mizuhara/pic10.jpg"),
        `${watermark}`,
        `${BotName}`,
        "6282327759039@s.whatsapp.net",
...
${themeemoji} MessageType : ${m.mtype}`;
    ...
    const textImg = (teks) => {
      Miku.sendMessage(
        m.chat,
        { text: teks },
        { quoted: m, thumbnail: fs.readFileSync("./Chizuru Mizuhara/pic4.jpg") }
      );
    };
    ...
    const fgi = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6282327759039-1613049930@g.us" } : {}),
      },
      message: {
        videoMessage: {
          title: `Kon ~MD`,
    ...
    Konichiwa ${pushname} dear 👋. I am ${
      global.BotName
    }, a bot developed by: Niskata to take your WhatsApp usage into next level.
    ...
    ©️ *${global.BotName}* All Rights Reserved by: *Niskata*
    `;
    ...
    if (smallinput == "bot") {
      reply(
        `Hello *${pushname}*, I am *${BotName}*, a WhatsApp bot made by *Niskata* and currently being hosted by *${OwnerName}*.  type  *${prefix}help* to get my full command list.`
      );
    }
      ...
      case "listgc":
        {
          ...
          let anu = await store.chats
            ...
            .map((v) => v.id);
          let teks = ` 「  _Kon's group user list_  」\n\nTotal ${anu.length} users are using bot in Groups.`;
          for (let i of anu) {
      ...
      case "nsfw":
        {
          ...
          if (args[0] === "on") {
            ...
            Miku.sendMessage(
              from,
              {
                text: `\`\`\`「 Notice 」\`\`\`\n\nNSFW(not safe for work) 18+ feature has been enabled in this group, which means anyone here can accesss Adult commands!`,
                contextInfo: { mentionedJid: mems },
              },
              { quoted: m }
            );
              ...
              .then(async (res) => {
                ...
                if (sizny < 20) {
                  ...
                  sendOrder(
                    ...
                    teks,
                    "6282327759039",
                    fs.readFileSync("./Chizuru Mizuhara/pic7.jpg"),
                    `${global.packname}`,
                    `${global.BotName}`,
                    "6282327759039@s.whatsapp.net",
      ...
      case "ytplay":
        {
          ...
          let buttonMessage = {
            ...
            caption: `「  _Kon Youtube Player 2.0_  」
      ...
      case "ytad":
        {
          ...
          if (fileSizeInBytes > 60000000)
            return reply("Cant send audios longer than 60 MB!");
      ...
      case "ytvd":
        {
          ...
          if (vidduration > 1800)
            return reply("Cant send videos longer than *30 min*");
          Miku.sendMessage(
            from,
            {
              video: { url: ytmp4play.videoUrl },
              mimetype: "video/mp4",
              caption: anu.title + " By *Kon ~MD*",
            },
            { quoted: m }
          );
        }
      ...
      case "ytdl":
        {
          ...
          let buttonMessage = {
            image: { url: anu.thumbnail },
            caption: `「  _Kon Youtube Downloader 2.0_  」
      ...
      case "steal":
        {
          ...
          if (isBanChat) return reply(mess.bangc);
          if (!args.join(" "))
            return reply(`Use command: -steal Kon|By : Niskata`);
          const swn = args.join(" ");
...
@${me.split("@")[0]} ❤️ @${jodoh.split("@")[0]}`;
      ...
      case "handsomecheck":
        ...
        if (isBanChat) return reply(mess.bangc);
        if (!text)
          return replay(`Tag Someone, Example : ${prefix + command} @Niskata`);
        const gan = [
          "1",
          "2",
          "3",
      ...
      case "dare":
        ...
        const dare = [
          ...
          "say i love the bot creator Niskata through voice note",
        ...
        buffer = await getBuffer(
          `https://wallpapercave.com/uwp/uwp2679279.jpeg`
        );
        Miku.sendMessage(
          from,
      ...
      case "truth":
        ...
        const truth = [
          ...
          "do you love the bot creator Niskata?",
...
*Link* : ${baby1[0].link}`;
      ...
      case "trap":
        ...
        await Mizu.sendMessage(m.chat, button2Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "hneko":
        ...
        await Mizu.sendMessage(m.chat, button3Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "hwaifu":
        ...
        await Mizu.sendMessage(m.chat, button4Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "gasm":
        ...
        await Mizu.sendMessage(m.chat, buttonsssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "smug2":
        ...
        await Mizu.sendMessage(m.chat, button1ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "foxgirl":
        ...
        await Mizu.sendMessage(m.chat, button12ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "animenom":
        ...
        await Mizu.sendMessage(m.chat, xx1button3Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "waifu3":
        ...
        await Mizu.sendMessage(m.chat, button112ssMessages, {
          quoted: m,
        }).catch((err) => {
          return "Error!";
        });
      ...
      case "cosplay":
        ...
        await Mizu.sendMessage(m.chat, cosplybutton, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "neko2":
        ...
        await Mizu.sendMessage(m.chat, buttonssMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "tickle":
        ...
        await Mizu.sendMessage(m.chat, buttonssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
...
*/
      ...
      case "megumin":
        ...
        await Mizu.sendMessage(m.chat, buttonzMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "awoo":
        ...
        await Mizu.sendMessage(m.chat, button1Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "waifu":
        ...
        await Mizu.sendMessage(m.chat, button4Messagess, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "neko":
        ...
        await Mizu.sendMessage(m.chat, buttonMessagessf, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "loli":
        ...
        await Mizu.sendMessage(m.chat, buttonMessagessfgr, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
...
✧ • *### ᴄʜɪᴢᴜʀᴜ-ᴍᴅ ᴍᴀᴅᴇ ʙʏ ꜱᴄᴏᴛᴄʜ*`;
          ...
          let buttonMessage = {
            video: fs.readFileSync("./Mizuhara/nelocry.mp4"),
            gifPlayback: true,
            caption: helpmenu,
            footer: `${BotName}`,
      ...
      case "":
        if (isCmd) {
          ...
          mizupic =
            "https://c.tenor.com/cHyx0ESAuIUAAAAC/mami-chizuru-oppai.gif";
          ...
          let buttonMessage = {
            video: fs.readFileSync("./Mizuhara/Horny.mp4"),
            gifPlayback: true,
      ...
      case "Kon":
        ...
        const Mizuharaselection =
          Mizuhara[Math.floor(Math.random() * Mizuhara)];

        Mizu.sendMessage(
          from,
          {
            video: { url: Mizuharaselection },
            gifPlayback: true,
            caption: txt,
          },
          { quoted: m }
      ...
      case "qrcode":
        ...
        var replqr = await getBuffer(
          `https://chizuru-mizuhara-qr.redeye7.repl.co/`
        );
        var qrbutton = [
          {
            buttonId: `${prefix}qr`,
